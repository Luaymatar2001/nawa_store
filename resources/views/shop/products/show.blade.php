                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">
                                {{$product->price_formatter}}
                                @if ($product->compare_price_formatter)
                                <span>{{$product->compare_price_formatter }}</span>
                                @endif
                            </h3>
                ...
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="single-block give-review">
                            <h4>{{$avarege_star}} (Overall)</h4>
                            <ul>
                                <li>
                                    <span>{{$avarege_star}} stars </span>
                                    @for($i = 0 ; $i < 5 ; $i++) @if ($i < $avarege_star) <i
                            ...
                            <div class="reviews">
                                ...
                                <div class="single-review">
                                    ...
                                    <div class="review-info">
                                        ...
                                        <ul class="stars">
                                            @for($i = 0 ; $i < 5 ; $i++) @if ($i < $reviews->star)
                ...
                <form action="{{route('product.reviews.store' , $product->slug)}}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="review" id="review-message" rows="8"
                                required></textarea>
                        </div>
                    </div>
