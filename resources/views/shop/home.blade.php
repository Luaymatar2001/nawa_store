<x-shop-layout title="Home" :show-breadcrumb="false">
    ...
    <span class="sale-tag">-{{($product->price / $product->compare_price)*100}}%</span>
    <div class="button">
        <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
    </div> --}}
    {{-- </div>
    ...
    {{-- </ul>
                            <div class="price">
                                <span>{{$product->price_formatter}}</span>
    <span class="discount-price">{{$product->compare_price_formatter}}</span>
    </div>
    </div>
    </div> --}}
    <!-- End Single Product -->
